...
<div style={{background: '#dc2626', color: 'white', padding: '1rem', borderRadius: '0.5rem', margin: '2rem 0'}}>
...
<div style={{background: '#ea580c', color: 'white', padding: '1rem', borderRadius: '0.5rem', margin: '2rem 0'}}>
...
<div style={{background: '#7c3aed', color: 'white', padding: '1rem', borderRadius: '0.5rem', margin: '2rem 0'}}>
