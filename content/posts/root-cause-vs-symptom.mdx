...
<div style={{background: '#dc2626', color: '#ffffff', padding: '1rem', borderRadius: '0.5rem', margin: '2rem 0'}}>
<strong style={{color: '#ffffff'}}>💡 ai optimizes for speed, not depth</strong><br/>
...
<div style={{background: '#ea580c', color: '#ffffff', padding: '1rem', borderRadius: '0.5rem', margin: '2rem 0'}}>
<strong style={{color: '#ffffff'}}>🔁 even knowing the pattern doesn't prevent repeating it</strong><br/>
...
<div style={{background: '#7c3aed', color: '#ffffff', padding: '1rem', borderRadius: '0.5rem', margin: '2rem 0'}}>
<strong style={{color: '#ffffff'}}>☠️ stale code is poison</strong><br/>
