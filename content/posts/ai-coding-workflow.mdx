...
<figure className="my-8 -mx-4 sm:mx-0">
  <div className="overflow-x-auto">
    <img
      src="/diagrams/ai-coding-workflow.svg"
      alt="AI Coding Workflow - from user story through multi-LLM critique to commit"
      className="min-w-[800px] w-full max-w-none sm:min-w-0"
    />
  </div>
  <figcaption className="text-center text-sm text-zinc-500 mt-2">
    Scroll horizontally on mobile to see full diagram
  </figcaption>
</figure>
...
- [Handoff](/posts/handoff) — Deliberate context reset before sessions degrade
